...
class Client(object):
    def __init__(self):
        ...
        self.neutron = NeutronClient.Client(username=self.args['os_username'], password=self.args['os_password'], tenant_name=self.args['os_tenant'], auth_url=self.args['os_auth_url'])
